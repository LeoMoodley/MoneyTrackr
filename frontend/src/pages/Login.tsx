...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if(formType == "signup") {
      ...
      const response = await fetch('https://moneytrackrz.netlify.app/api/register/', {
        method: 'POST',
        headers: {
      ...
      const response = await fetch('https://moneytrackrz.netlify.app/api/token/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const response = await fetch('https://moneytrackrz.netlify.app/api/password-reset/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
