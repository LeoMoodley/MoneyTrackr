...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if(formType == "signup") {
      ...
      const response = await fetch('https://3.15.229.131/api/register/', {
        method: 'POST',
        headers: {
      ...
      const response = await fetch('https://3.15.229.131/api/token/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const response = await fetch('https://3.15.229.131/api/password-reset/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
